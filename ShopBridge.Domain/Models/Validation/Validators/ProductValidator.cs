    ...
    public class ProductValidator : IValidator<Product>
    {
        ...
        public IEnumerable<BrokenRule> BrokenRules(Product entity)
        {
            if (string.IsNullOrEmpty(entity.Name))
                yield return new BrokenRule("Product Name", "Must include a Product Name.");

            if (string.IsNullOrEmpty(entity.Description))
                yield return new BrokenRule("Product Description", "Must include a Product Description.");
